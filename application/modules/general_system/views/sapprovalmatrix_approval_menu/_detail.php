...
<div class="row-flex">
	<label class="col-md-3 control-label no-padding-right">Approval Path Name</label>
	<div class="col-md-9">
...
<div class="row-flex">
	<label class="col-md-3 control-label no-padding-right">Approval Type</label>
	<div class="col-md-9">
		: <span class="approval_type"></span>
	</div>
</div>
<div class="row-flex" id="divAbsenceTypeView" style="display:none;">
    ...
    <div class="col-md-12">
		<div class="portlet box grey">
			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover approvalpic-list-view tablesaw tablesaw-stack" data-tablesaw-mode="stack" id="tblPic">
					<thead>
						<tr>
							<th scope="col">No</th>
							<th scope="col">Level</th>
							<th scope="col">Role</th>
							<th scope="col">Duration <br><span style="font-size:10px">(days)</span></th>
