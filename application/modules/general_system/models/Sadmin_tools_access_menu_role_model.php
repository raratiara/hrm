	...
	public function get_list_data()
	{
		...
		foreach ($rResult as $row) {
			...
			if (_USER_ACCESS_LEVEL_UPDATE == "1") {
				$edit = '<a class="btn btn-xs btn-primary" style="background-color: #FFA500; border-color: #FFA500;" href="' . base_url($this->folder_name . '/edit/' . $row->id) . '"><i class="fa fa-pencil"></i></a>';
			}
			$delete = "";
			if (_USER_ACCESS_LEVEL_DELETE == "1") {
				$delete = '<a class="btn btn-xs btn-danger" style="background-color: #A01818;" href="' . base_url($this->folder_name . '/delete/' . $row->id) . '" role="button"  data-toggle="modal" data-confirm="Apakah anda yakin ingin menghapus data ID : ' . $row->id . '?"><i class="fa fa-trash"></i></a>';
			}
