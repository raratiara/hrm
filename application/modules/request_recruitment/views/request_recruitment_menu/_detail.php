    ...
    <div class="col-md-12">
		<div class="portlet box green">
			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover requirement-list tablesaw tablesaw-stack" data-tablesaw-mode="stack" id="tblRequirement">
					<thead>
						<tr>
							<th scope="col">No</th>
...
<div class="row job">
    <div class="col-md-12">
		<div class="portlet box green">
			...
			<div class="portlet-body">
				<div class="table-scrollable tablesaw-cont">
				<table class="table table-striped table-bordered table-hover job-list tablesaw tablesaw-stack" data-tablesaw-mode="stack" id="tblJob">
					<thead>
						<tr>
							<th scope="col">No</th>
