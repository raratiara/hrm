...
{
	/* Module */
 	protected $folder_name				= "special_payroll_outsource/invoice_menu";
	...
	public function getRowData($id) { 
		$mTable = '(SELECT a.*, b.full_name as employee_name FROM time_attendances a left join employees b on b.id = a.employee_id where b.emp_source = "outsource" and b.is_special_payroll = 1
			)dt';
