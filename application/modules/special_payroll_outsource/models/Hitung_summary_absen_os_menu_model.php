...
class Hitung_summary_absen_os_menu_model extends MY_Model
{
	...
	{ 
		$where_date = " where b.emp_source = 'outsource' and b.is_special_payroll = 1";
		...
		if (
		    ...
		    $where_date = " WHERE b.emp_source = 'outsource' and b.is_special_payroll = 1 and (a.tgl_start <= '".$_GET['fldateend']."'
