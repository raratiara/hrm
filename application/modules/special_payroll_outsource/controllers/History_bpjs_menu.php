...
class History_bpjs_menu extends MY_Controller
{
	/* Module */
 	const  LABELMODULE				= "history_bpjs_menu"; // identify menu
 	const  LABELMASTER				= "Menu History BPJS";
 	const  LABELFOLDER				= "special_payroll_outsource"; // module folder
 	const  LABELPATH				= "history_bpjs_menu"; // controller file (lowercase)
