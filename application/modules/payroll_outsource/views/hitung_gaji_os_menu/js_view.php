...
$(document).ready(function() {
   	...
   	$('#filterEmployeeEdit').on('keyup', function() {
   		...
   		$('#tblDetailAbsenOSGaji tbody tr').filter(function() {
   	...
   	$('#filterEmployeeView').on('keyup', function() {
   		var value = $(this).val().toLowerCase();
   		$('#tblDetailGajiOSView tbody tr').filter(function() {
...
function setGajiBersih(val){ 
	...
	var GajiBersih = Number(subtotal)-(Number(bpjs_kes)+Number(bpjs_tk)+Number(payroll)+Number(pph120)+Number(pph21))+Number(pph21Adjustment);
