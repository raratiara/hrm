...
class Pembayaran_lembur_os_menu_model extends MY_Model
{
	/* Module */
 	protected $folder_name				= "payroll_outsource/pembayaran_lembur_os_menu";
	...
	public function get_list_data()
	{
		...
		foreach($rResult as $row)
		{
            ...
            $daftar_lembur = '<a class="btn btn-default btn-xs" style="align:center" onclick="getDaftarLemburOS('."'".$row->payroll_slip_id."'".')">
