...
class Bonus_thr_os_menu_model extends MY_Model
{
	...
	public function get_list_data()
	{
		...
		$whr_user = '';
		if($_SESSION['role'] != 1){
			$whr_user = ' and (ao.created_by = "'.$karyawan_id.'" or ao.direct_id = "'.$karyawan_id.'" or ao.is_approver_view = 1) ';
		}
		...
		$sTable = '(select ao.* from (select a.*, b.project_name, c.name_indo as month_name,
