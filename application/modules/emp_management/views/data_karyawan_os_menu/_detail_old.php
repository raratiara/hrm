<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="row">
			<label class="col-md-2 col-sm-4 col-xs-4 control-label no-padding-right">Employee Code</label>
	...
	<div class="col-md-6 col-sm-12 col-xs-12">
		...
		<div class="row">
			<label class="col-md-4 col-sm-4 col-xs-4 control-label no-padding-right">Tanggungan</label>
			<div class="col-md-8 col-sm-8 col-xs-8">
				: <span class="tanggungan"></span>
			</div>
		</div>
		<div class="row">
