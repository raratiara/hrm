				...
				<div class="col-md-12">
					<div class="portlet box">
						<div class="portlet-title">
							...
							<div class="tools">
								<input type="button" class="btn btn-default blue btn-outline btn-circle btn-sm active"
									id="addcarow" value="Add Row" />
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-scrollable tablesaw-cont">
								<table
									class="table table-striped table-bordered table-hover ca-list tablesaw tablesaw-stack"
									data-tablesaw-mode="stack" id="tblDetailEdu">
									<thead>
										<tr>
											<th scope="col">No</th>
	...
	<div class="tab-pane" id="address">
		<div class="row">
			...
			<div class="col-md-6 col-sm-12">
				...
				<div class="form-group">
					<label class="col-md-4 control-label no-padding-right">Is the Residential Address the same as the
						Address on the KTP? </label>
					<div class="col-md-8">
						<?= $chksameaddress; ?>
					</div>
				</div>
				...
				<div class="col-md-12">
					<div class="portlet box">
						<div class="portlet-title">
							...
							<div class="tools">
								<input type="button" class="btn btn-default blue btn-outline btn-circle btn-sm active"
									id="addcarow-training" value="Add Row" />
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-scrollable tablesaw-cont">
								<table
									class="table table-striped table-bordered table-hover ca-list-training tablesaw tablesaw-stack"
									data-tablesaw-mode="stack" id="tblDetailTraining">
									<thead>
										<tr>
											<th scope="col">No</th>
				...
				<div class="col-md-12">
					<div class="portlet box">
						<div class="portlet-title">
							...
							<div class="tools">
								<input type="button" class="btn btn-default blue btn-outline btn-circle btn-sm active"
									id="addcarow-org" value="Add Row" />
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-scrollable tablesaw-cont">
								<table
									class="table table-striped table-bordered table-hover ca-list-org tablesaw tablesaw-stack"
									data-tablesaw-mode="stack" id="tblDetailOrg">
									<thead>
										<tr>
											<th scope="col">No</th>
				...
				<div class="col-md-12">
					<div class="portlet box">
						<div class="portlet-title">
							...
							<div class="tools">
								<input type="button" class="btn btn-default blue btn-outline btn-circle btn-sm active"
									id="addcarow-workexp" value="Add Row" />
							</div>
						</div>
						<div class="portlet-body">
							<div class="table-scrollable tablesaw-cont">
								<table
									class="table table-striped table-bordered table-hover ca-list-workexp tablesaw tablesaw-stack"
									data-tablesaw-mode="stack" id="tblDetailWorkexp">
									<thead>
										<tr>
											<th scope="col">No</th>
