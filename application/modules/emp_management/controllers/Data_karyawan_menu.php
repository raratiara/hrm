...
{
	/* Module */
 	const  LABELMODULE				= "data_karyawan_menu"; // identify menu
 	const  LABELMASTER				= "Menu Data Karyawan";
 	const  LABELFOLDER				= "emp_management"; // module folder
 	const  LABELPATH				= "data_karyawan_menu"; // controller file (lowercase)
	...
	/* Export */
	public $colnames 				= [
		"ID","Emp Code","Full Name","Nick Name","Email","Phone","Gender","Date of Birth","Status","Is Tracking","Emp Source",
		// Personal
		...
		"Start PKWT","End PKWT","Total Hari Kerja",
		// Address
	...
	public $colfields 				= [
		"id","emp_code","full_name","nick_name","personal_email","personal_phone","gender_name","date_of_birth","status_name","is_tracking_name","emp_source",
		// Personal
		...
		"start_pkwt","end_pkwt","total_hari_kerja",
		// Address
