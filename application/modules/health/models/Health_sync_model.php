...
class Health_sync_model extends MY_Model
{
	/* Module */
 	protected $folder_name				= "health/Health_sync";
 	protected $table_name 				= _PREFIX_TABLE."health_sync_runs";
	...
	{ 
		...
		$sTable = '(select a.*, b.full_name from health_sync_runs a left join employees b on b.id = a.employee_id
				)dt';
	...
	{ 
		...
		$sql = "select a.*, b.full_name from health_sync_runs a left join employees b on b.id = a.employee_id
				ORDER BY a.id desc
		";
