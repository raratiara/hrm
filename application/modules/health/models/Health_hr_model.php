...
class Health_hr_model extends MY_Model
{
	/* Module */
 	protected $folder_name				= "health/Health_hr";
 	protected $table_name 				= _PREFIX_TABLE."health_raw_hr";
	...
	{ 
		...
		$sTable = '(select a.*, b.full_name from health_raw_hr a left join employees b on b.id = a.employee_id
				)dt';
	...
	{ 
		...
		$sql = "select a.*, b.full_name from health_raw_hr a left join employees b on b.id = a.employee_id
				ORDER BY a.id desc
		";
