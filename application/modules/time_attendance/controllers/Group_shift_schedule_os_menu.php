...
class Group_shift_schedule_os_menu extends MY_Controller
{
	/* Module */
 	const  LABELMODULE				= "group_shift_schedule_os_menu"; // identify menu
 	const  LABELMASTER				= "Menu Group Shift Schedule";
 	const  LABELFOLDER				= "time_attendance"; // module folder
 	const  LABELPATH				= "group_shift_schedule_os_menu"; // controller file (lowercase)
