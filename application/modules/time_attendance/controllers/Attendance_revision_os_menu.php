...
class Attendance_revision_os_menu extends MY_Controller
{
	/* Module */
 	const  LABELMODULE				= "attendance_revision_os_menu"; // identify menu
 	const  LABELMASTER				= "Menu Pengajuan Lupa Absen";
 	const  LABELFOLDER				= "time_attendance"; // module folder
 	const  LABELPATH				= "attendance_revision_os_menu"; // controller file (lowercase)
