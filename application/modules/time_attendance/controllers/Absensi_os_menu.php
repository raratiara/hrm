...
class Absensi_os_menu extends MY_Controller
{
	/* Module */
 	const  LABELMODULE				= "absensi_os_menu"; // identify menu
 	const  LABELMASTER				= "Menu Absensi Karyawan OS";
 	const  LABELFOLDER				= "time_attendance"; // module folder
 	const  LABELPATH				= "absensi_os_menu"; // controller file (lowercase)
