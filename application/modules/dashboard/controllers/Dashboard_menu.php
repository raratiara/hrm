...
class Dashboard_menu extends MY_Controller
{
	...
	//============================== Additional Method ==============================//
 	...
 	public function get_data_total(){
		...
		$ttl_earlylogin = $this->db->query("select count(a.id) as ttl from time_attendances a left join employees b on b.id = a.employee_id where b.emp_source = 'internal' and (a.is_late != 'Y' or a.is_late = '' or a.is_late is null) ".$whr_earlylogin.$whr2_earlylogin." ")->result(); 
