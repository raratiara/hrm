...
class Bypass extends API_Controller
{
	...
	public function tes_sendmail_reportabsensi()
	{
	...
	private function tes_sendmail($mail)
	{
		/*error_reporting(E_ALL);
		ini_set('display_errors', 1);*/
	...
	public function tes_downloadAbsenceReport(){ 
		/*error_reporting(E_ALL);
		ini_set('display_errors', 1);*/
		...
		if (file_exists($zipFilename)) {
			$this->tes_sendmail_reportabsensi();
		} else {
		    echo "Gagal menyimpan file ZIP.";
		}
