...
{ 
	/* Module */
 	const  LABELMODULE				= "data_project"; // identify menu
	...
	public $tabel_header 			= ["ID","No Project","Nama Project","Kode Customer","Tipe","Plan Tgl Start","Plan Tgl Finish","Actual Tgl Start","Actual Tgl Finish","Status"];
	
	/* Export */
	public $colnames 				= ["ID","No Project","Nama Project","Project Scope","Kode Customer","Tipe","No SPK/Kontrak","No PO/WO","Plan Tgl Start","Plan Tgl Finish","Actual Tgl Start","Actual Tgl Finish","Member","Status"];
	public $colfields 				= ["id","project","title","pscope","ccustomer","spk", "tipe","po","dpstart","dpfinish","dastart","dafinish","member","status"];
	...
	{ 
		...
		$field['txtidspk'] 			= $this->self_model->return_build_txt('','id_spk','id_spk');
		...
		$field['txtnilai_project'] 	= $this->self_model->return_build_txt('','nilai_project','nilai_project');
		$field['txtestimasi_cost'] 	= $this->self_model->return_build_txt('','estimasi_cost','estimasi_cost');
		...
		$field['seloPic'] 			= $this->self_model->return_build_select2me($oKaryawan,'','','','id_pic','id_pic','','','id','full_name',' ','','','',3,'-');
		$field['seloPM'] 			= $this->self_model->return_build_select2me($oKaryawan,'','','','id_pm','id_pm','','','id','full_name',' ','','','',3,'-'); 
