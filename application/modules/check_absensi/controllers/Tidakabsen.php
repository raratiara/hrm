...
class Tidakabsen extends MY_Controller
{
	/* Module */
 	const  LABELMODULE				= "tidakabsen"; // identify menu
 	const  LABELMASTER				= "Menu Data Tidak Absen";
 	const  LABELFOLDER				= "check_absensi"; // module folder
 	const  LABELPATH				= "tidakabsen"; // controller file (lowercase)
