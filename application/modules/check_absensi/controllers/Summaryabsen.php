...
class Summaryabsen extends MY_Controller
{ 
	/* Module */
 	const  LABELMODULE				= "summaryabsen"; // identify menu
 	const  LABELMASTER				= "Menu Summary Absen";
 	const  LABELFOLDER				= "check_absensi"; // module folder
 	const  LABELPATH				= "summaryabsen"; // controller file (lowercase)
	...
	public $tabel_header 			= ["Day", "Date","Absen","Tidak Absen","Total Karyawan"];

	
	/* Export */
	public $colnames 				= ["Date","Absen","Tidak Absen","Total Karyawan"];
	public $colfields 				= ["date_attendance","total_absen","total_tidak_absen","total_karyawan"];
