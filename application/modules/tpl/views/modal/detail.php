							...
							<div class="modal-content">
								<div class="modal-header bg-blue bg-font-blue no-padding">
									...
									<div class="table-header">
										...
										<?php
										if ($this->module_name == 'ijin_menu' || $this->module_name == 'fpu_menu' || $this->module_name == 'fpp_menu' || $this->module_name == 'settlement_menu' || $this->module_name == 'reimbursement_menu' || $this->module_name == 'lembur_menu') {
			                                ?>
