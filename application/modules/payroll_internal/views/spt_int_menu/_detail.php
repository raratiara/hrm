...
<div class="row sptintview" id="inpSptIntView">
    <div class="col-md-12">
		<div class="portlet box">
			...
			<div class="portlet-body">
				<div class="row" style="margin-bottom:10px;">
                    <div class="col-md-4">
                        <input type="text" id="filterEmployeeView_spt" class="form-control input-sm" placeholder="Cari nama karyawan...">
                    </div>
                </div>
				<div class="table-scroll-x">
					<div class="table-scrollable tablesaw-cont">
					<table class="table table-striped table-bordered table-hover sptint-list-view tablesaw tablesaw-stack" data-tablesaw-mode="stack" id="tblDetailSptInt_view">
						<thead>
							<tr>
								<th scope="col"></th>
								<th scope="col">NIK</th>
