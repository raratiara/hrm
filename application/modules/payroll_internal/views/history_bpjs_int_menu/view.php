    ...
    <div class="row filter-wrap" style="margin-top:15px">
		  ...
		  <div class="col-md-5 col-sm-12">
		    <div class="form-group row form-row">
		      <label class="col-sm-4 col-form-label" style="text-align:right;">Sudah di Setor?</label>
		      <div class="col-sm-8">
		        <select id="fldisetor" name="fldisetor" class="form-control">
		        	<option value=''></option>
		        	<option value='1'>Sudah di Setor</option>
		        	<option value='0'>Belum di Setor</option>
		        </select>
		      </div>
		    </div>
		  </div>
		  ...
		  <div class="col-md-5 col-sm-12">
		    <div class="form-group row form-row">
		      <label class="col-sm-6 col-form-label" style="text-align:right;">Sudah di Kembalikan?</label>
		      <div class="col-sm-6">
		        <select id="fldikembalikan" name="fldikembalikan" class="form-control">
		        	<option value=''></option>
