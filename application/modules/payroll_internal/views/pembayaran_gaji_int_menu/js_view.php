...
<div id="modal-daftar-gaji" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-daftar-gaji" aria-hidden="true">
	<div class="vertical-alignment-helper">
	<div class="modal-dialog vertical-align-center">
		<div class="modal-content" style="width:500px !important">
			<form class="form-horizontal" id="frmDaftarGaji" enctype="multipart/form-data">
			...
			<div class="modal-footer no-margin-top">
				...
				<button class="btn" style="background-color: #8ec1f5; color: black; border-radius: 2px !important;" id="submit-report-data" onclick="downloadDaftarGaji()">
        ...
        success: function(data)
        {
			if(data != false){
				if(save_method == 'update'){ 
					...
					getPeriodeGaji('selected',data.payroll_slip_id)
...
function getDaftarGaji(payroll_id){
	
	$('#modal-daftar-gaji').modal('show');

	$('[name="hdnpayrollid"]').val(payroll_id);
}

function downloadDaftarGaji (){
	...
	if(payroll_id != ''){
  		...
  		// send_url = 
		send_url = module_path+'/getDaftarGaji?payroll_id='+payroll_id+'';
		formData = $('#frmDaftarGaji').serialize();
		window.location = send_url+'&'+formData;
		$('#modal-daftar-gaji').modal('hide');
...
function getPeriodeGaji(selected='',idVal=''){ 
