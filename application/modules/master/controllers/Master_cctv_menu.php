...
class Master_cctv_menu extends MY_Controller
{
	/* Module */
 	const  LABELMODULE				= "master_cctv_menu"; // identify menu
 	const  LABELMASTER				= "Menu Setup Master CCTV";
 	const  LABELFOLDER				= "master"; // module folder
 	const  LABELPATH				= "master_cctv_menu"; // controller file (lowercase)
