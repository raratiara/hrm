...
class Master_mother_vessel_menu_model extends MY_Model
{
	/* Module */
 	protected $folder_name				= "master/master_mother_vessel_menu";
 	protected $table_name 				= _PREFIX_TABLE."mother_vessel";
