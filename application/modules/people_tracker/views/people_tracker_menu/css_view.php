<style type="text/css">
  ...
  .chart_monthly_att_summ {
    ...
    width: 300px;
    float: left;
    /* atau gunakan display: inline-block */
  }
...
@keyframes bounceMarker {
  ...
  :root {
    --topbar-height: 90px;
    /* sesuaikan: tinggi topbar kamu */
    --panel-gap: 14px;
    /* jarak tambahan dari topbar */
  }
  ...
  /* Toggle button juga ikut turun biar konsisten */
  .video-toggle {
  ...
  /* Biar header rounding kelihatan */
  ...
  .video-container-absensi {
    top: calc(var(--topbar-height) + var(--panel-gap) + 220px) !important;
    /* adjust */
    right: 25px !important;
