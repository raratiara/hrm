...
<div class="video-container" id="videoContainer">
  <div class="filter-card">
    ...
    <div class="filter-group">
      ...
      <select id="fltipe" name="fltipe" class="filter-select">
    ...
    <div class="filter-group">
      <label class="filter-label">Select Period</label>
      <input type="text" class="form-control filter-input" id="fldashperiod" name="fldashperiod">
    </div>
  </div>
</div>
