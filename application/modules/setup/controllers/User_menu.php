...
{
	/* Module */
 	const  LABELMODULE				= "user_menu"; // identify menu
 	const  LABELMASTER				= "Menu User";
 	const  LABELFOLDER				= "setup"; // module folder
 	const  LABELPATH				= "user_menu"; // controller file (lowercase)
	...
	public $tabel_header 			= ["ID","Name","Email","Username"];

	
	/* Export */
	public $colnames 				= ["ID","Name","Email","Username"];
