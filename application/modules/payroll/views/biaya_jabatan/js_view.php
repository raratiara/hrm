        ...
        { 
			if(data != false){
				if(save_method == 'update'){
					...
					$('[name="max_monthly"]').val(data.max_monthly);
					$('[name="max_yearly"]').val(data.max_yearly);
				...
				if(save_method == 'detail'){
					$('span.percentage').html(data.percentage);
					$('span.max_monthly').html(data.max_monthly);
					$('span.max_yearly').html(data.max_yearly);
