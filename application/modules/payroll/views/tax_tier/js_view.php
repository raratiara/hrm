        ...
        { 
			if(data != false){
				if(save_method == 'update'){
					...
					$('[name="min_pkp"]').val(data.min_pkp);
					$('[name="max_pkp"]').val(data.max_pkp);
				...
				if(save_method == 'detail'){
					...
					$('span.min_pkp').html(data.min_pkp);
					$('span.max_pkp').html(data.max_pkp);
					$('span.tax_percentage').html(data.tax_percentage);
