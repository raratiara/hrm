...
class Ptkp_categories_model extends MY_Model
{
	/* Module */
 	protected $folder_name			= "payroll/ptkp_categories";
 	protected $table_name 			= _PREFIX_TABLE."ptkp_categories"; 
	...
	public function add_data($post) {  
		$data = [
			'code' 		 		=> trim($post['code']),
			'ptkp_amount' 	 	=> trim($post['ptkp_amount']),
