...
class Tax_tier_model extends MY_Model
{
	/* Module */
 	protected $folder_name			= "payroll/tax_tier";
 	protected $table_name 			= _PREFIX_TABLE."tax_tiers"; 
	...
	public function add_data($post) { 
		...
		$data = [
			'name' 		 		=> trim($post['name']),
			'min_pkp' 		 	=> trim($post['min_pkp']),
			'max_pkp' 			=> trim($post['max_pkp']),
			'tax_percentage' 	=> trim($post['tax_percentage']),
