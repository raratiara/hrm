...
class Ter_model extends MY_Model
{
	/* Module */
 	protected $folder_name			= "payroll/ter";
 	protected $table_name 			= _PREFIX_TABLE."tax_effective_rates"; 
	...
	public function get_list_data()
	{
		...
		foreach($rResult as $row)
		{
			...
			array_push($output["aaData"],array(
				...
				$row->id,
				$row->category,
				$row->min_gross_income,
				$row->max_gross_income, 
				$row->effective_rate
			));
		}
	...
	public function add_data($post) {  
		$data = [
			...
			'min_gross_income' 	 	=> trim($post['min_gross_income']),
			'max_gross_income' 		=> trim($post['max_gross_income']),
			'effective_rate' 		=> trim($post['effective_rate']) , 
