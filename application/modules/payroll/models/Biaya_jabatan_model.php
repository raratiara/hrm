...
class Biaya_jabatan_model extends MY_Model
{
	/* Module */
 	protected $folder_name			= "payroll/biaya_jabatan";
 	protected $table_name 			= _PREFIX_TABLE."biaya_jabatan"; 
	...
	public function add_data($post) { 
		...
		$data = [
			...
			'max_monthly' 		 	=> trim($post['max_monthly']),
			'max_yearly' 			=> trim($post['max_yearly']),
