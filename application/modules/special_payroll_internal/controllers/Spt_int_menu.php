...
class Spt_int_menu extends MY_Controller
{
	/* Module */
 	const  LABELMODULE				= "spt_int_menu"; // identify menu
 	const  LABELMASTER				= "Menu SPT Internal";
 	const  LABELFOLDER				= "special_payroll_internal"; // module folder
 	const  LABELPATH				= "spt_int_menu"; // controller file (lowercase)
	...
	public $tabel_header 			= ["ID", "Tahun Pajak","Tgl Generate","Status"];

	
	/* Export */
	public $colnames 				= ["ID", "Tahun Pajak","Tgl Generate","Status"];
	public $colfields 				= ["id","tahun","created_at","status_name"];
