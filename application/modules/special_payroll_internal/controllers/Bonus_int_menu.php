...
class Bonus_int_menu extends MY_Controller
{
	...
	const LABELMASTER = "Menu Perhitungan Bonus Special Payroll Internal";
	const LABELFOLDER = "special_payroll_internal";
	const LABELPATH = "bonus_int_menu";
	const LABELNAVSEG1 = "special_payroll_internal";
