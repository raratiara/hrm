...
class History_bpjs_int_menu extends MY_Controller
{
	/* Module */
 	const  LABELMODULE				= "history_bpjs_int_menu"; // identify menu
 	const  LABELMASTER				= "Menu History BPJS";
 	const  LABELFOLDER				= "special_payroll_internal"; // module folder
 	const  LABELPATH				= "history_bpjs_int_menu"; // controller file (lowercase)
	...
	public $tabel_header 			= ["ID","Periode Gaji"];


	/* Export */
	public $colnames 				= ["ID","Periode Gaji"];
	public $colfields 				= ["id","periode"];
