...
class Pembayaran_gaji_int_menu extends MY_Controller
{
	/* Module */
 	const  LABELMODULE				= "pembayaran_gaji_int_menu"; // identify menu
 	const  LABELMASTER				= "Menu Pembayaran Gaji";
 	const  LABELFOLDER				= "special_payroll_internal"; // module folder
 	const  LABELPATH				= "pembayaran_gaji_int_menu"; // controller file (lowercase)
 	const  LABELNAVSEG1				= "special_payroll_internal"; // adjusted 1st sub parent segment
	...
	//============================== Additional Method ==============================//
 	...
 	public function getDaftarGaji(){
		...
		function generateSheet($sheetName, $dataset, $periode){
		...
		// ================== GENERATE 2 SHEET ==================
		generateSheet('Bank Mandiri', $data_mandiri, $periode_penggajian);
		generateSheet('Bank Lain', $data_lain, $periode_penggajian);
		...
		header("Content-Disposition: attachment; filename=Daftar Gaji.xls");
	...
	public function getDataPeriodeGaji(){
		...
		$rs =  $this->self_model->getDataPeriodeGaji();
