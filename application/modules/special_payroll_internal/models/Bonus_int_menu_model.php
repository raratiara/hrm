...
{
	protected $folder_name = "special_payroll_internal/bonus_int_menu";
	protected $table_name = _PREFIX_TABLE."special_bonus_internal";
	protected $detail_table_name = _PREFIX_TABLE."special_bonus_internal_detail";
	protected $detail_foreign_key = "special_bonus_internal_id";
	protected $amount_field = "bonus_amount";
	protected $total_header_field = "total_bonus";
	protected $primary_key = "id";
	protected $employee_source = "internal";
	protected $approval_matrix_type_id = 22;
