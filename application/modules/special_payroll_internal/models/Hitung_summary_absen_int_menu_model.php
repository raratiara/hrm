...
class Hitung_summary_absen_int_menu_model extends MY_Model
{
	...
	public function get_list_data()
	{
		...
		{
			$cek_payslip = $this->db->query("select id from special_payroll_slip_internal where bulan_penggajian = ".$row->bulan_penggajian." and tahun_penggajian = '".$row->tahun_penggajian."' limit 1")->result();
