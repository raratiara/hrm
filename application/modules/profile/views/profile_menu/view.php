...
<div class="dashboard-container">
    ...
    <div class="profile-section">
        ...
        <div class="profile-side-cards">
            ...
            <div class="events-box">
                <h4 class="birthday-title" style="color:#38406F;">This Week's Highlights</h4>
    ...
    <div class="info-3cards-section">

        <div class="health-monitoring-flex">
    ...
    <div class="charts-2cards-section">
    ...
    <!-- TASKLIST PROGRESS DI BAWAH SENDIRI -->
    <div class="tasklist-bottom-section">
