...
<div class="dashboard-container">
    ...
    <div class="profile-section">
        ...
        <div class="health-card p-3 rounded shadow text-center">
            <i class="fa fa-calendar" style="font-size: 12px; font-weight:bold; color: #0a1739;"></i> <span id="lastLog"
                style="font-size: 12px; font-weight:bold; color: #0a1739; margin-left: 4px;"></span>
    ...
    background: #FBD9E5;" id="bpm_desc"></span>
                    ...
                    <div class="card-box cardbox-2">
                        ...
                        <h3><span id="bpm"></span></h3>
                        <span class="badge" id="bpm_desc"></span>
                    </div>
    ...
    background: #FFE264;" id="spo2_desc"></span>
                    ...
                    <div class="card-box cardbox-4">
                        ...
                        <span class="badge" id="spo2_desc"></span>
                    </div>
                ...
                <div class="col-md-6 col-12">
                    ...
                    <!-- <div class="card-box" style="background: #F76400;">
                        ...
                        <p>Sleep</p>
                        <small><span
                                style="color:#3D1203; background:#FFD3A5; padding: 3px; border-radius:8px !important"
                                id="sleep_percent"></span></small>
                    </div> -->

                    <div class="card-box cardbox-3">
                        ...
                        <small><span class="badge" id="sleep_percent"></span></small>
                    </div>
                    <!-- Fatigue -->
    ...
    background: #D0E3FF;" id="fatigue_category">Moderate</span>
                    ...
                    <div class="card-box cardbox-1">
                        ...
                        <span class="badge" id="fatigue_category">Moderate</span>
                    </div>
                </div>
            </div>
            ...
            <div>
                <button class="btn btn-circle btn-health" style="margin-top:10px;" onclick="goHealthDetails()">
                    See Detail >>
                </button>
            </div>
        </div>
            ...
            <div class="birthday-box">
                ...
                <div class="birthday-header">
                    <h4 class="birthday-title">Today’s Birthdays <span class="birthday-span"> <svg
                                ...
                                <path fill="#ffc107"
                                    d="M7.45 123.27c2.27 2.46 11.62-1.83 19-5.27c5.53-2.57 27.66-11.65 38.66-16.36c2.97-1.27 7.29-2.93 10.4-7.02c2.76-3.64 10.08-19.1-4.66-34.76c-14.96-15.9-30.37-11.51-36.13-7.43c-3.39 2.4-6.15 7.81-7.39 10.56c-5.24 11.62-12.71 32.91-15.75 41.28c-2.23 6.17-6.38 16.56-4.13 19" />
                                <path fill="#ff8f00"
                                    d="M25.85 66.49c.14 1.74.49 4.57 1.69 10.02c.82 3.74 2.16 7.66 3.25 10.25c3.27 7.79 7.86 10.93 12.51 13.45c7.9 4.28 13.27 5.08 13.27 5.08l-6.44 2.63s-3.9-.81-9.22-3.43c-5.07-2.5-10.35-6.73-14.21-15.01c-1.67-3.59-2.64-7.07-3.2-9.83c-.69-3.42-.8-5.36-.8-5.36zm-7.91 20.28s.8 6.49 6.16 14.68c6.28 9.58 15.05 11.15 15.05 11.15l-5.83 2.4s-6.51-1.99-12.7-10.44c-3.86-5.27-4.94-11.57-4.94-11.57zm-5.55 15.38s1.46 5.6 4.66 9.78c3.81 4.99 8.66 6.44 8.66 6.44l-4.47 1.98s-3.39-.71-7.1-5.41c-2.82-3.57-3.62-7.67-3.62-7.67z" />
                                <path fill="#fffde7"
                                    d="M9.96 116.37c-.2-.45-.2-.96.01-1.4l25.47-52.82l4.19 15.75l-26.8 38.71c-.72 1.08-2.34.94-2.87-.24"
                                    opacity="0.44" />
                                <linearGradient id="SVGs8hxXbEl" x1="74.384" x2="44.617" y1="61.839" y2="79.699"
                                    gradientUnits="userSpaceOnUse">
                                    <stop offset=".024" stop-color="#8f4700" />
                                    <stop offset="1" stop-color="#703e2d" />
                                </linearGradient>
                                <path fill="url(#SVGs8hxXbEl)"
                                    d="M41.65 83.19c11.9 13.92 25.45 12.18 29.96 8.66c4.52-3.53 8.09-15.66-3.76-29.35c-12.42-14.34-26.48-10.25-29.73-7.15s-7.39 15.07 3.53 27.84" />
                                <path fill="#03a9f4"
                                ...
                                <path fill="#c92b27"
                                    d="M43.99 38.79c-.19 2.2-.28 3.51.29 6.37c2.75 2.02 8.74 2.02 8.74 2.02c-.26-.81-.49-1.51-.59-2.01c-.02-.07-.03-.15-.05-.22c-6.09-3.04-8.39-6.16-8.39-6.16" />
                                ...
                                <path fill="#03a9f4"
                                    d="m25.61 21.27l-7.6-2.49c.87-2.66 1.1-5.53.65-8.3l7.9-1.27c.65 4.02.32 8.19-.95 12.06" />
                                <path fill="#fb8c00" d="m73.073 15.325l7.815-1.71l2.257 10.316l-7.815 1.71z" />
                                <path fill="#ffc107"
                                    d="m92.46 17.77l-5.5-5.81c2.88-2.73 3.54-6.3 3.54-6.34l7.9 1.29c-.1.63-1.11 6.29-5.94 10.86" />
                                <path fill="#fb8c00" d="m95.514 48.58l6.987-2.184l2.386 7.636l-6.987 2.184z" />
                                <path fill="#f44336"
                                    d="m97.55 113.03l-7.95-.94c.34-2.83-1.77-6.3-2.35-7.07l6.4-4.8c.48.63 4.65 6.4 3.9 12.81" />
                                <path fill="#fb8c00"
                                    d="M120.37 102.89c-2.99-.45-6.05-.63-9.07-.52l-.27-8c3.51-.12 7.06.08 10.53.61z" />
                                <path fill="#f48fb1" d="m109.614 113.902l5.62-5.693l7.735 7.638l-5.62 5.692z" />
                                <path fill="#f44336" d="m93.103 63.334l5.78 6.609l-6.609 5.78l-5.78-6.609z" />
                            </svg></span></h4>
                ...
                <div class="birthday-content">
                    ...
                    <img id="birthday-avatar" alt="Profile Picture" class="birthday-image">
